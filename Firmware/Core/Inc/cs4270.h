...
#define CS4270_I2C_HANDLE		hi2c2
#define CS4270_NRST_GPIO_PORT 	Codec_RST_GPIO_Port
#define CS4270_NRST_GPIO_PIN	Codec_RST_Pin

// I2C address
#define CS4270_I2C_ADDRESS				0x90 // 0b[1001 A2 A1 A0], A[2:0] = 0 --> 0b1001000 = 0x48
