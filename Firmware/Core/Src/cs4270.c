...
HAL_StatusTypeDef CS4270_RegWrite(uint8_t regAddr, uint8_t regData) {
	...
	return HAL_I2C_Mem_Write(&CS4270_I2C_HANDLE, CS4270_I2C_ADDRESS, regAddr, I2C_MEMADD_SIZE_8BIT, &regData, 1, 100);

}

HAL_StatusTypeDef CS4270_RegRead(uint8_t regAddr, uint8_t *regData) {

	return HAL_I2C_Mem_Read(&CS4270_I2C_HANDLE, CS4270_I2C_ADDRESS, regAddr, I2C_MEMADD_SIZE_8BIT, regData, 1, 100);
